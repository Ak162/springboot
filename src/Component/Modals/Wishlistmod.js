...
export default function Wishlistmod(props) {
  return (
    <Modal
      {...props}
      size="md"
      ...
      <Modal.Body>
        <div className="wishlist_inner">
          ...
          <Form>
            ...
            <FormGroup>
              <Label for="exampleEmail">Enter Your Address</Label>
              <Input
                type="text"
            ...
            <div className="btn-submit mt-4">
              <Button onClick={props?.onSubmit} className="btnsubmit">
                SUBMIT WHITELIST
              </Button>
            </div>
          </Form>

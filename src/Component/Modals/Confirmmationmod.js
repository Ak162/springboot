...
export default function Confirmmationmod(props) {
  return (
    <Modal
      {...props}
      size="md"
    ...
    >
      <Modal.Body>
        <div className="editmod_inner pt-5">
          ...
          <Form onSubmit={props.DeleteWallet}>
           <div className="text-center">
            ...
            <div className="btn-submit d-flex gap-3 mt-5">
            <Button className="btnsubmit">
                No
              </Button>
              <Button className="btnsubmit" onClick={props.onDelete}>
                Yes
              </Button>
            </div>
          </Form>
